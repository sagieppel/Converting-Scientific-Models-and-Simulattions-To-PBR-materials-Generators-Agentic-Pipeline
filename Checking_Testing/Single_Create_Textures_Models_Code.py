...
# -------------------------------Recheck idea originality optional recheck the idea is not already in the list of implemented models in the dataset -------------------------------------------------------------------------------------------------
        ...
        code_query=dt['qr']['implement_code'].replace("**method_description**",bname).replace("**method_name**",bdesc)
...
if __name__=="__main__":
        query_dir = "queries_prompts//pbr_general//" # Folder where prompts/queries are save
        outputdir = "PBR_Generated_gpt55330_8/" # output folder where the generated dataset will be saved,
        # Gpt 5.5 0.45 usd for image (1.5 ils)
        # 326 10 assets
        # 321.6
        # GPT 5.4 45 15
        # GLM 5.1 305.3
        ...
        model = "z-ai/glm-5.1" #"openai/gpt-5.5"#"google/gemini-3.1-flash-lite-preview"#"openai/gpt-5.4"#google/gemini-3.1-flash-lite-preview"#"z-ai/glm-5.1"#"google/gemini-3.1-flash-lite-preview"#"z-ai/glm-5.1"#google/gemini-3.1-flash-lite-preview"#"z-ai/glm-5.1"## "google/gemini-3.1-flash-lite-preview"#"google/gemini-3-flash-preview" # model for writing code (and defult for everthing else) "z-ai/glm-4.7-flash"#"moonshotai/kimi-k2.6"#openai/gpt-5.2"#grok-4-fast-reasoning"#"Qwen/Qwen2.5-VL-72B-Instruct"#"claude-sonnet-4-5-20250929" #"grok-4-fast-reasoning"#"gemini-2.5-flash"#"Qwen/Qwen2.5-VL-72B-Instruct"#"gpt-5"
        idea_model = "z-ai/glm-5.1"# "openai/gpt-5.5"#"google/gemini-3.1-flash-lite-preview"#"openai/gpt-5.4"#google/gemini-3.1-flash-lite-preview"#"z-ai/glm-5.1"#"google/gemini-3.1-flash-lite-preview"# "z-ai/glm-5.1"#google/gemini-3.1-flash-lite-preview"#"z-ai/glm-5.1"#"google/gemini-3.1-flash-lite-preview"#"moonshotai/kimi-k2.5" # model for suggesting idea (if blank use  model)
        # gpt 54 0.33 usd per set (1 ils)
